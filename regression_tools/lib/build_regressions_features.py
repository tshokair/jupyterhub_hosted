...
class FeatureData():
    ...
    def __init__(self, json, dependent_variable, 
                 independent_variables, positive_outcomes,
                 negative_outcomes):
    ...
    def processed(self):
        ...
        processed_df['first_choice'] =\
            processed_df.apply(lambda row: row['structure']['choices'][0], axis = 1)
    ...
    def full_features(self):
        ...
        snippet_df_full =\
            processed.pivot(index='snippet_id',
    ...
    def encoded_features(self):
        ...
        for question in self.question_list:
            ...
            feature_copy[col_name] =\
                encoders[question].transform(feature_copy[question])
        return feature_copy
